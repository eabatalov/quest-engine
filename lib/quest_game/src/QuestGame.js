function QuestGame(name, levelRepo,
    persistentStorage, inAppPurchaseProvider,
    levelGameplayHistorySaver, levelGameplayHistoryLoader) {
    this.name = name;
    this.levelRepo = levelRepo;
    this.persistentStorage = persistentStorage;
    this.inAppPurchaseProvider = inAppPurchaseProvider;
    this.levelGameplayHistorySaver = levelGameplayHistorySaver;
    this.levelGameplayHistoryLoader = levelGameplayHistoryLoader;
...
QuestGame.newGame = function(name, levelLoader, persistentStorage, inAppPurchaseProvider,
    ...
    return new QuestGame(name, new LevelRepository(levelLoader), persistentStorage,
        inAppPurchaseProvider, levelGameplayHistorySaver, levelGameplayHistoryLoader);
};
...
QuestGame.prototype.getLevelGameplayHistorySaver = function() {
    return this.levelGameplayHistorySaver;
};

QuestGame.prototype.getLevelGameplayHistoryLoader = function() {
    return this.levelGameplayHistoryLoader;
};
 ...
 */
QuestGame.load = function(savedData, levelLoader,
    persistentStorage, inAppPurchaseProvider,
    levelGameplayHistorySaver, levelGameplayHistoryLoader) {
