...
LevelRepository.prototype.forEachLevel = function(callback/*levelName, level*/) {
    jQuery.each(this.levels, callback);
};
...
LevelRepository.prototype._loadLevel = function(levelSavedData) {
    //XXX Almost copypaste of _createLevel
    var levelName = this.levelLoader.loadName(levelSavedData);
    this.pendingRequests[levelName] = true;
