function LevelReplay(levelGameplayHistory, level, isAbnormalExit) {
    this.history = levelGameplayHistory;
    this.level = level;
    this.devName = null;
    this.screenRes = null;
    this.gameURL = null;
    this.isAbnormalExit = isAbnormalExit ? true : false;
};
...
LevelReplay.prototype.getIsAbnormalExit = function() {
...
LevelReplay.prototype.save = function() {
    var savedData = {
        ...
        isAbnormalExit : this.getIsAbnormalExit(),
...
LevelReplay.load = function(savedData, level) {
    ...
    replay.isAbnormalExit = savedData.isAbnormalExit;
    return replay;
};
