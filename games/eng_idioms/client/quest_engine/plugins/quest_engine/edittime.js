...
{
	return {
		"name":			"Quest Engine",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"QuestLogicPlugin",				// this is used to i`ntify this plugin and is saved to the project; never change it
		"version":		"0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Learzing quest game engine",
